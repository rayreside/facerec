            ...
            <article className="br3 w-100">
                ...
                <div className="flannel flex flex-column items-center signForm-inner br3 br--bottom ph4 pv3 w-100">
                    <fieldset id="sign_up" className="b--transparent w-100">
                        ...
                        <input className="b pa2 br2 input-reset bn w-100" type="password" name="password" placeholder='Password'  id="password" />
                    </fieldset>
                    <input 
                    ...
                    <p onClick={() =>onRouteChange('Register')} 
                        className="yBG ph2 dib f5 b pointer">Don't have an account? Sign up</p>
                </div>
            </article>
        </div>
    )
