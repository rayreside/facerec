            ...
            <article className="br3 w-100">
                ...
                <div className="flannel flex flex-column items-center regForm-inner br3 br--bottom ph4 pv3 w-100">
                    <fieldset id="register" className="b--transparent">
                        <input className="pa2 mb2 br2 input-reset ba bw1 w-100" type="text" name="name" placeholder='Name' id="name" />
                        <input className="pa2 mb2 br2 input-reset ba bw1 w-100" type="email" name="email-address" placeholder='Email' id="email-address" />
                        <input className="pa2 mb2 br2 b input-reset ba bw1 w-100" type="password" name="password" placeholder='Password' id="password" />
                        <input className="pa2 mb2 br2 b input-reset ba bw1 w-100" type="password" name="confpassword" placeholder='Confirm Password' id="confpassword" />
                    </fieldset>
                    <input 
                    ...
                    className="yBG dib f5 b pointer">Already have an account? Sign in</p>
                </div>
            </article>
        </div>
    )
